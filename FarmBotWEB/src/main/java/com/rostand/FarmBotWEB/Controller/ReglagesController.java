...
import com.rostand.FarmBotWEB.DTO.CreateReglagesDTO;
import com.rostand.FarmBotWEB.Entity.Reglages;
import com.rostand.FarmBotWEB.Repository.ReglagesRepository;
...
public class ReglagesController {
    ...
    public List getReglages() { return reglagesRepo.findAll(); }
    ...
    public ResponseEntity<Reglages> updateReglages(@PathVariable Long id, @RequestBody CreateReglagesDTO reglagesDTO) throws NotFoundException {
    ...
    @PostMapping(path = "/student/delete/{id}")
    @ResponseBody
